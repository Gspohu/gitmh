				...
				<thead>
  				...
  				<tbody>
					<tr>
						...
						<td class="center"><b class="free">Free</b></td>
						<td><input class="pricing_tab_select" type="checkbox" name="bugT" id="bugT" checked="checked" disabled="disabled"/></td>
					</tr>
					<tr>
						<td>Colaborative tools</td>
						<td></td>
						<td class="center"><b class="free">Free</b></td>
						<td><input class="pricing_tab_select" type="checkbox" name="bugT" id="bugT" checked="checked" disabled="disabled"/></td>
					</tr>
					<tr>
						<td>Unlimited public project</td>
						<td></td>
						<td class="center"><b class="free">Free</b></td>
						<td><input class="pricing_tab_select" type="checkbox" name="bugT" id="bugT" checked="checked" disabled="disabled"/></td>
					</tr>
					...
					<tr>
						<td>Space</td>
						<td><input class="buy_nb" type="number" name="nbGo" id="nbGo" max="500" min="1" step="1" value="1"></code> Go</td>
						<td class="center">1€</td>
						<td><input class="pricing_tab_select" type="checkbox" name="bugT" id="bugT" /></td>
					</tr>
					<tr>
						<td>Tips button</td>
						<td><input class="buy_nb" type="number" name="nbTipsB" id="nbTipsB" max="100" min="1" step="1" value="1"> Tips button</td>
